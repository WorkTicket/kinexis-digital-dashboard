      ...
      <div className="animate-fade-up relative w-full max-w-[26rem]">
        ...
        <div className="space-y-3">
          ...
          >
              ...
              >
                {cfConnected ? (
                  ...
                  <span className="relative inline-flex">
                    ...
                    <span
                      className="absolute -bottom-0.5 -right-0.5 h-1.5 w-1.5 rounded-sm"
                      style={{ backgroundColor: CLOUDFLARE_ORANGE }}
                      aria-hidden
                    />
                  </span>
                )}
            ...
            {cfConnected ? (
              <div
                className="mt-4 border border-kinexis-focus/20 bg-kinexis-focus/[0.04] p-4"
                style={{ borderRadius: "var(--radius-md)" }}
              >
        ...
        {error && (
          <div
            className="mt-4 flex items-start gap-2 border border-kinexis-risk/25 px-4 py-3 text-[13px] text-kinexis-risk"
            style={{ borderRadius: "var(--radius-md)" }}
          >
        ...
        <div className="mb-6 mt-5 flex items-start gap-2">
